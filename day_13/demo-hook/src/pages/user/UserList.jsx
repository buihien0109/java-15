                        ...
                        <table className="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Hà Nội</td>
                                    <td>
                                        <Link to={"/users/1"} className="btn btn-success">Xem chi tiết</Link>
                                ...
                                <tr>
                                    ...
                                    <td>Hà Nội</td>
                                    <td>
                                        <Link to={"/users/2"} className="btn btn-success">Xem chi tiết</Link>
                                        <button className="btn btn-danger">Xóa</button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Hà Nội</td>
                                    <td>
                                        <Link to={"/users/3"} className="btn btn-success">Xem chi tiết</Link>
                                        <button className="btn btn-danger">Xóa</button>
                                    </td>
                                </tr>
                            </tbody>
